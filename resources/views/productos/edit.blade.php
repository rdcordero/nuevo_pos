                    ...
                    <form action="{{ route('productos.update', $producto) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('tipo') is-invalid @enderror" 
                                            ...
                                            name="tipo" 
                                            required>
                                        <option value="simple" {{ old('tipo', $producto->tipo) == 'simple' ? 'selected' : '' }}>Simple</option>
                                        <option value="compuesto" {{ old('tipo', $producto->tipo) == 'compuesto' ? 'selected' : '' }}>Compuesto</option>
                                    </select>
                                    @error('tipo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="punto_reorden" 
                                           name="punto_reorden" 
                                           value="{{ old('punto_reorden', $producto->punto_reorden) }}" 
                                           min="0" 
                                           required>
                                    @error('punto_reorden')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="codigos-barra-list">
                                @foreach($producto->codigosBarra as $codigoBarra)
                                <div class="row mb-2 codigo-barra-row">
                                    <div class="col-md-11">
                                        <input type="text" 
                                               class="form-control" 
                                               name="codigos_barra[]" 
                                               value="{{ $codigoBarra->codigo }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input type="checkbox" 
                                                   ...
                                                   name="impuestos[]" 
                                                   value="{{ $impuesto->id }}"
                                                   {{ in_array($impuesto->id, old('impuestos', $producto->impuestos->pluck('id')->toArray())) ? 'checked' : '' }}>
                        ...
                        <div id="componentes-section" class="card mb-3" style="{{ old('tipo', $producto->tipo) == 'compuesto' ? '' : 'display: none;' }}">
                            <div class="card-header">
                                ...
                                <div id="componentes-container">
                                    ...
                                    <div id="componentes-list">
                                        ...
                                        <div class="row mb-2 componente-row">
                                            <div class="col-md-6">
                                                <select name="componentes[{{ $loop->index }}][id]" class="form-select" required>
                                                    <option value="">Seleccione un producto</option>
                                                    @foreach($productos as $prod)
                                                        <option value="{{ $prod->id }}" 
                                                                {{ $componente->id == $prod->id ? 'selected' : '' }}>
                                                            {{ $prod->nombre }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-5">
                                                <input type="number" 
                                                       name="componentes[{{ $loop->index }}][cantidad]" 
                                                       class="form-control" 
                                                       step="0.01" 
                                                       min="0.01" 
                                                       value="{{ $componente->pivot->cantidad }}"
                                                       required>
                                            </div>
                                            <div class="col-md-1">
...
<script>
// Variables globales
let componenteIndex = {{ $producto->componentes->count() }};
let codigoBarraIndex = {{ $producto->codigosBarra->count() }};
...
// Función para agregar códigos de barra
...
// Función para eliminar códigos de barra
