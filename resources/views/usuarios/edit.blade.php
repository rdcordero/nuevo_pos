                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    ...
                                                    {{ in_array($id, old('roles', $usuarioRoles)) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    ...
                                                    value="{{ $id }}"
                                                    {{ in_array($id, old('empresas', $usuarioEmpresas)) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                value="{{ $sucursalId }}"
                                                                {{ in_array($sucursalId, old('sucursales', $usuarioSucursales)) ? 'checked' : '' }}>
