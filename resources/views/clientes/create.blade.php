                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tipo_cliente') is-invalid @enderror" id="tipo_cliente"
                                    ...
                                    <option value="contribuyente"
                                        {{ old('tipo_cliente') == 'contribuyente' ? 'selected' : '' }}>
                                        Contribuyente
                                    </option>
                                    <option value="no_contribuyente"
                                        {{ old('tipo_cliente') == 'no_contribuyente' ? 'selected' : '' }}>
                                        No Contribuyente
                                    </option>
                                </select>
                                @error('tipo_cliente')
                            ...
                            <div id="documentos-contribuyente" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nrc') is-invalid @enderror"
                                        id="nrc" name="nrc" value="{{ old('nrc') }}" placeholder="######-#">
                                    @error('nrc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select
                                        class="form-select select2 @error('actividad_economica_codigo') is-invalid @enderror"
                                        id="actividad_economica_codigo" name="actividad_economica_codigo"
                                        ...
                                        @foreach ($actividadesEconomicas as $actividad)
                                            <option value="{{ $actividad->codigo }}"
                                                {{ old('actividad_economica_codigo') == $actividad->codigo ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nit') is-invalid @enderror" id="nit"
                                    name="nit" value="{{ old('nit') }}" placeholder="####-######-###-#">
                                @error('nit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div id="documentos-no-contribuyente" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('dui') is-invalid @enderror"
                                        id="dui" name="dui" value="{{ old('dui') }}" placeholder="########-#">
                                    @error('dui')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2 @error('pais_id') is-invalid @enderror" id="pais_id"
                                    name="pais_id" required data-placeholder="Seleccione el país">
                                    <option value="">Seleccione el país</option>
                                    @foreach ($paises as $pais)
                                        <option value="{{ $pais->codigo }}"
                                            {{ old('pais_id') == $pais->codigo ? 'selected' : '' }}>
                                            {{ $pais->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('municipio') is-invalid @enderror" id="municipio"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('distrito') is-invalid @enderror" id="distrito"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('categoria') is-invalid @enderror" id="categoria"
                                    ...
                                    <option value="normal" {{ old('categoria') == 'normal' ? 'selected' : '' }}>Normal
                                    </option>
                                    <option value="frecuente" {{ old('categoria') == 'frecuente' ? 'selected' : '' }}>
                                        Frecuente</option>
                                    <option value="vip" {{ old('categoria') == 'vip' ? 'selected' : '' }}>VIP</option>
                                </select>
                                @error('categoria')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('limite_credito', '0.00') }}" step="0.01"
                                                min="0" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="dias_credito" name="dias_credito" value="{{ old('dias_credito', '0') }}"
                                            min="0" required>
                                        @error('dias_credito')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('vendedor') is-invalid @enderror"
                                    id="vendedor" name="vendedor" value="{{ old('vendedor') }}">
                                @error('vendedor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="exento" name="exento"
                                        value="1" {{ old('exento') ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="gran_contribuyente"
                                        name="gran_contribuyente" value="1"
                                        {{ old('gran_contribuyente') ? 'checked' : '' }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#actividad_economica_codigo').select2({
                ...
                width: '100%',
                dropdownParent: $(
                '#documentos-contribuyente'), // Importante para el correcto funcionamiento cuando está oculto
                language: {
                    noResults: function() {
                        return "No se encontraron resultados";
                    },
            ...
            async function cargarActividadesEconomicas() {
                ...
                try {
                    ...
                    $('#actividad_economica_codigo').empty().append(
                        '<option value="">Seleccione la actividad</option>');
